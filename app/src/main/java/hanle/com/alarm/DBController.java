...
public class DBController extends SQLiteOpenHelper {
    ...
    public DBController(Context applicationcontext) {
        super(applicationcontext, "alarm.db", null, 1);
    ...
    public void onCreate(SQLiteDatabase database) {
        String query;
        query = "CREATE TABLE events ( eID INTEGER, event_title TEXT, event_status TEXT, share_detial INT, user_attending_status INT, inviter_name TEXT, dat Text, tim TEXT)";
